// @kuikly-autogen {"pageName":"CodecModuleTestPage","category":"modules","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/modules/CodecModuleTestPage.kt","managedBy":"kuikly-web-autotest","templateProfile":"module-generic"}
import { test, expect } from '../../../fixtures/test-base';

const PAGE_NAME = "CodecModuleTestPage";
const TITLE_TEXT = "CodecModuleTestPage";
const STABLE_TEXTS = [
  "CodecModuleTestPage",
  "urlEncode:${ctx.urlEncode}",
  "urlDecode:${ctx.urlDecode}",
