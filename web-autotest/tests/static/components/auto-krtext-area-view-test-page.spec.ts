// @kuikly-autogen {"pageName":"KRTextAreaViewTestPage","category":"components","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/components/KRTextAreaViewTestPage.kt","managedBy":"web-autotest","templateProfile":"default","targetClassification":"static","specLocation":"web-autotest/tests/static/components/auto-krtext-area-view-test-page.spec.ts","migrationPhase":"semantic-closure","repairReason":"coverage-refresh","repairStrategy":null,"repairStep":0,"repairLadderStep":null}
import { test, expect } from '../../../fixtures/test-base';

const PAGE_NAME = "KRTextAreaViewTestPage";
...
const INTERACTION_HINTS = {
  ...
  "actionScripts": [
    {
      "kind": "click",
      "targetLabel": "textarea-readonly-inactive",
      "expectLabel": "textarea-readonly-active"
    },
    {
      "kind": "click",
