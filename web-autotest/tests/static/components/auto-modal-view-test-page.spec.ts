// @kuikly-autogen {"pageName":"ModalViewTestPage","category":"components","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/components/ModalViewTestPage.kt","managedBy":"web-autotest","templateProfile":"default","targetClassification":"static","specLocation":"web-autotest/tests/static/components/auto-modal-view-test-page.spec.ts","migrationPhase":"semantic-closure","repairReason":"coverage-refresh","repairStrategy":null,"repairStep":0,"repairLadderStep":null}
import { test, expect } from '../../../fixtures/test-base';

const PAGE_NAME = "ModalViewTestPage";
const TITLE_TEXT = "ModalViewTestPage";
const STABLE_TEXTS = [
  "ModalViewTestPage",
...
const ACTION_LABELS = [
  ...
  "Dismiss",
  "Close Inner",
  "dismiss-count: ${ctx.dismissCount}",
  "Modal Content",
  "Nested Modal"
];
