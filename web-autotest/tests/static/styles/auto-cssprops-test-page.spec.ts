// @kuikly-autogen {"pageName":"CSSPropsTestPage","category":"styles","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/styles/CSSPropsTestPage.kt","managedBy":"web-autotest","templateProfile":"default","targetClassification":"static","specLocation":"web-autotest/tests/static/styles/auto-cssprops-test-page.spec.ts","migrationPhase":"semantic-closure","repairReason":"missing-spec","repairStrategy":null,"repairStep":0,"repairLadderStep":null}
import { test, expect } from '../../../fixtures/test-base';

const PAGE_NAME = "CSSPropsTestPage";
const TITLE_TEXT = "1. Text Shadow";
const STABLE_TEXTS = [
  "1. Text Shadow",
  "shadow-text",
  "multi-shadow-text",
...
const INTERACTION_HINTS = {
  ...
  "actionScripts": [
    {
      "kind": "click",
      "targetLabel": "touch-enabled",
      "expectLabel": "touch-disabled"
    },
    {
      "kind": "click",
      "targetLabel": "touch-disabled",
      "expectLabel": "touch-enabled"
    }
  ],
  "maxActionLabels": 4,
