// @kuikly-autogen {"pageName":"PageListTestPage","category":"interactions","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/interactions/PageListTestPage.kt","managedBy":"web-autotest","templateProfile":"interaction-page-list","targetClassification":"functional","specLocation":"web-autotest/tests/functional/auto-page-list-test-page.spec.ts","migrationPhase":"semantic-closure","repairReason":"coverage-refresh","repairStrategy":null,"repairStep":0,"repairLadderStep":null}
...
const ACTION_LABELS = [
  "no-anim:${ctx.nonAnimScrollCount}"
];
