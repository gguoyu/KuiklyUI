// @kuikly-autogen {"pageName":"KRViewTouchTestPage","category":"interactions","sourceFile":"demo/src/commonMain/kotlin/com/tencent/kuikly/demo/pages/web_test/interactions/KRViewTouchTestPage.kt","managedBy":"web-autotest","templateProfile":"interaction-generic","targetClassification":"functional","specLocation":"web-autotest/tests/functional/auto-krview-touch-test-page.spec.ts","migrationPhase":"semantic-closure","repairReason":"coverage-gap","repairStrategy":null,"repairStep":0,"repairLadderStep":null}
import { test, expect } from '../../fixtures/test-base';

const PAGE_NAME = "KRViewTouchTestPage";
const TITLE_TEXT = "1. Touch Events";
const STABLE_TEXTS = [
  "1. Touch Events",
  "touch-area",
  "touch-down: ${ctx.touchDownCount}",
  "touch-move: ${ctx.touchMoveCount}"
];
const ACTION_LABELS = [
  "lp-count: ${ctx.longPressCount}"
];
const INTERACTION_HINTS = {
  ...
  "actionScripts": [
    {
      "kind": "click",
      "targetLabel": "touch-area",
      "expectLabel": "touch-down: 1"
    },
    {
      "kind": "dblclick",
      "targetLabel": "dblclick-idle",
      "expectLabel": "dblclick-count: 1"
    }
  ],
  "maxActionLabels": 2,
